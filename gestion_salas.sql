--------------------------------------------------------
-- Archivo creado  - miércoles-noviembre-19-2025   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table AUTENTICACION
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."AUTENTICACION" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AUTH_GROUP" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AUTH_PERMISSION" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"NAME" NVARCHAR2(255), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AUTH_USER_GROUPS" 
   (	"ID" NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"USER_ID" NUMBER(11,0), 
	"GROUP_ID" NUMBER(11,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" 
   (	"ID" NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"USER_ID" NUMBER(11,0), 
	"PERMISSION_ID" NUMBER(11,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table BD_LOG
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."BD_LOG" 
   (	"ID_LOG" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CLIENTES" 
   (	"ID_CLIENTE" VARCHAR2(50 BYTE), 
	...
	"AUTENTICADO" NUMBER(1,0) DEFAULT 0 -- 0 = No autenticado, 1 = Autenticado
...
--------------------------------------------------------
 ...
 LOB ("DESCRIPCION") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("ACTIVIDADES") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW 4000 CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table DESTINOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."DESTINOS" 
   (	"ID_DESTINO" NUMBER, 
	"NOMBRE" VARCHAR2(100 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DJANGO_ADMIN_LOG" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DJANGO_CONTENT_TYPE" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DJANGO_MIGRATIONS" 
   (	"ID" NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"APP" NVARCHAR2(255), 
	"NAME" NVARCHAR2(255), 
	"APPLIED" TIMESTAMP (6)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DJANGO_SESSION" 
...
--------------------------------------------------------
--  DDL for Table PAQUETE_DESTINO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAQUETE_DESTINO" 
   (	"ID_PAQUETE" NUMBER, 
	"ID_DESTINO" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PAQUETE_DESTINOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAQUETE_DESTINOS" 
   (	"ID_PAQUETE" NUMBER(*,0), 
	"ID_DESTINO" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PAQUETES_DESTINOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAQUETES_DESTINOS" 
   (	"ID_PAQUETE" VARCHAR2(50 BYTE), 
	"ID_DESTINO" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PAQUETES_TURISTICOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAQUETES_TURISTICOS" 
   (	"ID_PAQUETE" VARCHAR2(50 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PAQUETETURISTICO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAQUETETURISTICO" 
   (	"ID_PAQUETE" NUMBER, 
	"PRECIO_TOTAL" NUMBER(10,2) DEFAULT 0
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PAQUETETURISTICOS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAQUETETURISTICOS" 
   (	"ID_PAQUETE" NUMBER(*,0), 
	"PRECIO_TOTAL" NUMBER(10,2) DEFAULT 0.00
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SALAS_REGISTROACCESO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SALAS_REGISTROACCESO" 
   (	"ID" NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SALAS_RESERVA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SALAS_RESERVA" 
   (	"ID" NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"RUT" NVARCHAR2(12), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SALAS_SALA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SALAS_SALA" 
   (	"ID" NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"NOMBRE" NVARCHAR2(100), 
	"CAPACIDAD_MAXIMA" NUMBER(11,0), 
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUTENTICACION
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUTH
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUTH_GROUP
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUTH_GROUP_PERMISSIONS
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUTH_PERMISSION
SET DEFINE OFF;
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('1','Can add log entry','1','add_logentry');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('2','Can change log entry','1','change_logentry');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('3','Can delete log entry','1','delete_logentry');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('4','Can view log entry','1','view_logentry');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('5','Can add permission','2','add_permission');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('6','Can change permission','2','change_permission');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('7','Can delete permission','2','delete_permission');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('8','Can view permission','2','view_permission');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('9','Can add group','3','add_group');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('10','Can change group','3','change_group');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('11','Can delete group','3','delete_group');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('12','Can view group','3','view_group');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('13','Can add user','4','add_user');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('14','Can change user','4','change_user');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('15','Can delete user','4','delete_user');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('16','Can view user','4','view_user');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('17','Can add content type','5','add_contenttype');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('18','Can change content type','5','change_contenttype');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('19','Can delete content type','5','delete_contenttype');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('20','Can view content type','5','view_contenttype');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('21','Can add session','6','add_session');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('22','Can change session','6','change_session');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('23','Can delete session','6','delete_session');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('24','Can view session','6','view_session');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('25','Can add sala','7','add_sala');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('26','Can change sala','7','change_sala');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('27','Can delete sala','7','delete_sala');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('28','Can view sala','7','view_sala');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('29','Can add reserva','8','add_reserva');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('30','Can change reserva','8','change_reserva');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('31','Can delete reserva','8','delete_reserva');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('32','Can view reserva','8','view_reserva');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('33','Can add registro acceso','9','add_registroacceso');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('34','Can change registro acceso','9','change_registroacceso');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('35','Can delete registro acceso','9','delete_registroacceso');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values ('36','Can view registro acceso','9','view_registroacceso');
REM INSERTING into SYSTEM.AUTH_USER
SET DEFINE OFF;
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values ('1','pbkdf2_sha256$1000000$qOkiddXdEEDibCZM6rC0S3$FYR539K4T4wsafvQoCHckEBk7TfCkDfmqln+zw48iqM=',to_timestamp('20/11/25 01:34:59,204010000','DD/MM/RR HH24:MI:SSXFF'),'1','admin',null,null,null,'1','1',to_timestamp('19/11/25 12:42:33,300417000','DD/MM/RR HH24:MI:SSXFF'));
REM INSERTING into SYSTEM.AUTH_USER_GROUPS
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUTH_USER_USER_PERMISSIONS
SET DEFINE OFF;
REM INSERTING into SYSTEM.BD_LOG
SET DEFINE OFF;
REM INSERTING into SYSTEM.CLIENTES
SET DEFINE OFF;
REM INSERTING into SYSTEM.DESTINO
SET DEFINE OFF;
Insert into SYSTEM.DESTINO (ID_DESTINO,NOMBRE,COSTO) values ('1','Playa Paraíso','150');
REM INSERTING into SYSTEM.DESTINOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.DJANGO_ADMIN_LOG
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values ('1',to_timestamp('19/11/25 12:52:38,260912000','DD/MM/RR HH24:MI:SSXFF'),'Sala 101','1','7','1');
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values ('2',to_timestamp('19/11/25 12:53:01,982756000','DD/MM/RR HH24:MI:SSXFF'),'Sala 102','1','7','1');
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values ('3',to_timestamp('19/11/25 12:53:17,045388000','DD/MM/RR HH24:MI:SSXFF'),'Sala Computación','1','7','1');
REM INSERTING into SYSTEM.DJANGO_CONTENT_TYPE
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('1','admin','logentry');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('2','auth','permission');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('3','auth','group');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('4','auth','user');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('5','contenttypes','contenttype');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('6','sessions','session');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('7','salas','sala');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('8','salas','reserva');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values ('9','salas','registroacceso');
REM INSERTING into SYSTEM.DJANGO_MIGRATIONS
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('1','contenttypes','0001_initial',to_timestamp('19/11/25 12:22:19,451274000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('2','auth','0001_initial',to_timestamp('19/11/25 12:22:20,013324000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('3','admin','0001_initial',to_timestamp('19/11/25 12:22:20,141123000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('4','admin','0002_logentry_remove_auto_add',to_timestamp('19/11/25 12:22:20,149005000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('5','admin','0003_logentry_add_action_flag_choices',to_timestamp('19/11/25 12:22:20,156197000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('6','contenttypes','0002_remove_content_type_name',to_timestamp('19/11/25 12:22:20,860837000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('7','auth','0002_alter_permission_name_max_length',to_timestamp('19/11/25 12:22:20,915199000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('8','auth','0003_alter_user_email_max_length',to_timestamp('19/11/25 12:22:20,931888000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('9','auth','0004_alter_user_username_opts',to_timestamp('19/11/25 12:22:20,941926000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('10','auth','0005_alter_user_last_login_null',to_timestamp('19/11/25 12:22:20,975236000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('11','auth','0006_require_contenttypes_0002',to_timestamp('19/11/25 12:22:20,978402000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('12','auth','0007_alter_validators_add_error_messages',to_timestamp('19/11/25 12:22:20,988593000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('13','auth','0008_alter_user_username_max_length',to_timestamp('19/11/25 12:22:21,004972000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('14','auth','0009_alter_user_last_name_max_length',to_timestamp('19/11/25 12:22:21,023358000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('15','auth','0010_alter_group_name_max_length',to_timestamp('19/11/25 12:22:21,048662000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('16','auth','0011_update_proxy_permissions',to_timestamp('19/11/25 12:22:21,060196000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('17','auth','0012_alter_user_first_name_max_length',to_timestamp('19/11/25 12:22:21,076569000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('18','salas','0001_initial',to_timestamp('19/11/25 12:22:21,152720000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('19','sessions','0001_initial',to_timestamp('19/11/25 12:22:21,181076000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('20','salas','0002_registroacceso',to_timestamp('20/11/25 01:29:40,292864000','DD/MM/RR HH24:MI:SSXFF'));
REM INSERTING into SYSTEM.DJANGO_SESSION
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_SESSION (SESSION_KEY,EXPIRE_DATE) values ('7t0uwcipxzf6drd59iouz4li7ke8givo',to_timestamp('04/12/25 01:34:59,207508000','DD/MM/RR HH24:MI:SSXFF'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MASCOTA
SET DEFINE OFF;
Insert into SYSTEM.MASCOTA (ID,NOMBRE,APODO) values ('1','Lucero','Luci');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PAQUETE_DESTINO
SET DEFINE OFF;
Insert into SYSTEM.PAQUETE_DESTINO (ID_PAQUETE,ID_DESTINO) values ('101','1');
REM INSERTING into SYSTEM.PAQUETE_DESTINOS
SET DEFINE OFF;
Insert into SYSTEM.PAQUETE_DESTINOS (ID_PAQUETE,ID_DESTINO) values ('101','1');
REM INSERTING into SYSTEM.PAQUETES_DESTINOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PAQUETES_TURISTICOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PAQUETETURISTICO
SET DEFINE OFF;
Insert into SYSTEM.PAQUETETURISTICO (ID_PAQUETE,PRECIO_TOTAL) values ('101','150');
REM INSERTING into SYSTEM.PAQUETETURISTICOS
SET DEFINE OFF;
Insert into SYSTEM.PAQUETETURISTICOS (ID_PAQUETE,PRECIO_TOTAL) values ('101','150');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SALAS_REGISTROACCESO
SET DEFINE OFF;
Insert into SYSTEM.SALAS_REGISTROACCESO (ID,TIPO_USUARIO,ACCION,USERNAME,RUT,CARRERA,DETALLE,FECHA_HORA) values ('1','ADMIN','LOGOUT','admin',null,null,'Cierre de sesión administrador',to_timestamp('20/11/25 01:30:05,900651000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.SALAS_REGISTROACCESO (ID,TIPO_USUARIO,ACCION,USERNAME,RUT,CARRERA,DETALLE,FECHA_HORA) values ('2','ESTUDIANTE','LOGIN',null,'19.515.609-3','Informatica','Inicio de sesión estudiante',to_timestamp('20/11/25 01:30:27,751509000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.SALAS_REGISTROACCESO (ID,TIPO_USUARIO,ACCION,USERNAME,RUT,CARRERA,DETALLE,FECHA_HORA) values ('3','ESTUDIANTE','LOGOUT',null,'19.515.609-3','Informatica','Cierre de sesión estudiante',to_timestamp('20/11/25 01:32:09,940078000','DD/MM/RR HH24:MI:SSXFF'));
Insert into SYSTEM.SALAS_REGISTROACCESO (ID,TIPO_USUARIO,ACCION,USERNAME,RUT,CARRERA,DETALLE,FECHA_HORA) values ('4','ADMIN','LOGIN','admin',null,null,'Inicio de sesión administrador',to_timestamp('20/11/25 01:34:59,206424000','DD/MM/RR HH24:MI:SSXFF'));
REM INSERTING into SYSTEM.SALAS_RESERVA
SET DEFINE OFF;
REM INSERTING into SYSTEM.SALAS_SALA
SET DEFINE OFF;
Insert into SYSTEM.SALAS_SALA (ID,NOMBRE,CAPACIDAD_MAXIMA,DISPONIBLE) values ('1','Sala 101','4','1');
Insert into SYSTEM.SALAS_SALA (ID,NOMBRE,CAPACIDAD_MAXIMA,DISPONIBLE) values ('2','Sala 102','6','1');
Insert into SYSTEM.SALAS_SALA (ID,NOMBRE,CAPACIDAD_MAXIMA,DISPONIBLE) values ('3','Sala Computación','10','1');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."AUTH_GROU_GROUP_ID__0CD325B0_U" ON "SYSTEM"."AUTH_GROUP_PERMISSIONS" ("GROUP_ID", "PERMISSION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."AUTH_PERM_CONTENT_T_01AB375A_U" ON "SYSTEM"."AUTH_PERMISSION" ("CONTENT_TYPE_ID", "CODENAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."AUTH_USER_USER_ID_G_94350C0C_U" ON "SYSTEM"."AUTH_USER_GROUPS" ("USER_ID", "GROUP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."AUTH_USER_USER_ID_P_14A6B632_U" ON "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ("USER_ID", "PERMISSION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."DJANGO_CO_APP_LABEL_76BD3D3B_U" ON "SYSTEM"."DJANGO_CONTENT_TYPE" ("APP_LABEL", "MODEL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_PERMI_CONTENT_TY_2F476E4B" ON "SYSTEM"."AUTH_PERMISSION" ("CONTENT_TYPE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index SALAS_RESERVA_SALA_ID_C9AA6ABE
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."SALAS_RESERVA_SALA_ID_C9AA6ABE" ON "SYSTEM"."SALAS_RESERVA" ("SALA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_USER__GROUP_ID_97559544" ON "SYSTEM"."AUTH_USER_GROUPS" ("GROUP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_GROUP_GROUP_ID_B120CBF9" ON "SYSTEM"."AUTH_GROUP_PERMISSIONS" ("GROUP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_USER__PERMISSION_1FBB5F2C" ON "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ("PERMISSION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_GROUP_PERMISSION_84C5C92E" ON "SYSTEM"."AUTH_GROUP_PERMISSIONS" ("PERMISSION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_USER__USER_ID_6A12ED8B" ON "SYSTEM"."AUTH_USER_GROUPS" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."AUTH_USER__USER_ID_A95EAD1B" ON "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."DJANGO_SES_EXPIRE_DAT_A5C62663" ON "SYSTEM"."DJANGO_SESSION" ("EXPIRE_DATE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."DJANGO_ADM_USER_ID_C564EBA6" ON "SYSTEM"."DJANGO_ADMIN_LOG" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "SYSTEM"."DJANGO_ADM_CONTENT_TY_C4BCE8EB" ON "SYSTEM"."DJANGO_ADMIN_LOG" ("CONTENT_TYPE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_PERMISSION" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_PERMISSION" MODIFY ("CONTENT_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_PERMISSION" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_PERMISSION" ADD CONSTRAINT "AUTH_PERM_CONTENT_T_01AB375A_U" UNIQUE ("CONTENT_TYPE_ID", "CODENAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" ADD PRIMARY KEY ("ID_CLIENTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DJANGO_SESSION" MODIFY ("SESSION_KEY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_SESSION" MODIFY ("EXPIRE_DATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_SESSION" ADD PRIMARY KEY ("SESSION_KEY")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table PAQUETETURISTICO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETETURISTICO" ADD PRIMARY KEY ("ID_PAQUETE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_USER" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER" MODIFY ("IS_SUPERUSER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER" MODIFY ("IS_STAFF" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER" MODIFY ("IS_ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER" MODIFY ("DATE_JOINED" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER" ADD CHECK ("IS_SUPERUSER" IN (0,1)) ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER" ADD CHECK ("IS_STAFF" IN (0,1)) ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER" ADD CHECK ("IS_ACTIVE" IN (0,1)) ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER" ADD UNIQUE ("USERNAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DESTINO" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DESTINO" MODIFY ("COSTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DESTINO" ADD PRIMARY KEY ("ID_DESTINO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" MODIFY ("GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" MODIFY ("PERMISSION_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" ADD CONSTRAINT "AUTH_GROU_GROUP_ID__0CD325B0_U" UNIQUE ("GROUP_ID", "PERMISSION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" )  ENABLE;
--------------------------------------------------------
--  Constraints for Table PAQUETES_TURISTICOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETES_TURISTICOS" ADD PRIMARY KEY ("ID_PAQUETE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RESERVAS" MODIFY ("FECHA_RESERVA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."RESERVAS" ADD PRIMARY KEY ("ID_RESERVA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MASCOTA" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MASCOTA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table PAQUETES_DESTINOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETES_DESTINOS" ADD PRIMARY KEY ("ID_PAQUETE", "ID_DESTINO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" MODIFY ("ACTION_TIME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" MODIFY ("ACTION_FLAG" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" ADD CHECK ("ACTION_FLAG" >= 0) ENABLE;
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DJANGO_MIGRATIONS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_MIGRATIONS" MODIFY ("APPLIED" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_MIGRATIONS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BD_LOG" MODIFY ("CONECTADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."BD_LOG" ADD PRIMARY KEY ("ID_LOG")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DESTINOS" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DESTINOS" MODIFY ("DESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DESTINOS" MODIFY ("COSTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DESTINOS" ADD PRIMARY KEY ("ID_DESTINO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table PAQUETETURISTICOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETETURISTICOS" ADD PRIMARY KEY ("ID_PAQUETE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table SALAS_SALA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SALAS_SALA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_SALA" MODIFY ("CAPACIDAD_MAXIMA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_SALA" MODIFY ("DISPONIBLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_SALA" ADD CHECK ("DISPONIBLE" IN (0,1)) ENABLE;
  ALTER TABLE "SYSTEM"."SALAS_SALA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTENTICACION" MODIFY ("PASSWORD_HASH" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTENTICACION" ADD PRIMARY KEY ("USUARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH" MODIFY ("PASSWORD_HASH" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH" ADD PRIMARY KEY ("USUARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table PAQUETE_DESTINOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETE_DESTINOS" ADD PRIMARY KEY ("ID_PAQUETE", "ID_DESTINO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" MODIFY ("GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" ADD CONSTRAINT "AUTH_USER_USER_ID_G_94350C0C_U" UNIQUE ("USER_ID", "GROUP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table SALAS_RESERVA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SALAS_RESERVA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_RESERVA" MODIFY ("HORA_INICIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_RESERVA" MODIFY ("HORA_FIN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_RESERVA" MODIFY ("SALA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_RESERVA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" MODIFY ("PERMISSION_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ADD CONSTRAINT "AUTH_USER_USER_ID_P_14A6B632_U" UNIQUE ("USER_ID", "PERMISSION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DJANGO_CONTENT_TYPE" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DJANGO_CONTENT_TYPE" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DJANGO_CONTENT_TYPE" ADD CONSTRAINT "DJANGO_CO_APP_LABEL_76BD3D3B_U" UNIQUE ("APP_LABEL", "MODEL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAQUETE_DESTINO" ADD PRIMARY KEY ("ID_PAQUETE", "ID_DESTINO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table SALAS_REGISTROACCESO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SALAS_REGISTROACCESO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_REGISTROACCESO" MODIFY ("FECHA_HORA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SALAS_REGISTROACCESO" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_GROUP" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUTH_GROUP" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_GROUP" ADD UNIQUE ("NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" ADD CONSTRAINT "AUTH_GROU_GROUP_ID_B120CBF9_F" FOREIGN KEY ("GROUP_ID")
	  REFERENCES "SYSTEM"."AUTH_GROUP" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_GROUP_PERMISSIONS" ADD CONSTRAINT "AUTH_GROU_PERMISSIO_84C5C92E_F" FOREIGN KEY ("PERMISSION_ID")
	  REFERENCES "SYSTEM"."AUTH_PERMISSION" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AUTH_PERMISSION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."AUTH_PERMISSION" ADD CONSTRAINT "AUTH_PERM_CONTENT_T_2F476E4B_F" FOREIGN KEY ("CONTENT_TYPE_ID")
	  REFERENCES "SYSTEM"."DJANGO_CONTENT_TYPE" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AUTH_USER_GROUPS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" ADD CONSTRAINT "AUTH_USER_USER_ID_6A12ED8B_F" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."AUTH_USER" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER_GROUPS" ADD CONSTRAINT "AUTH_USER_GROUP_ID_97559544_F" FOREIGN KEY ("GROUP_ID")
	  REFERENCES "SYSTEM"."AUTH_GROUP" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AUTH_USER_USER_PERMISSIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ADD CONSTRAINT "AUTH_USER_USER_ID_A95EAD1B_F" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."AUTH_USER" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
  ALTER TABLE "SYSTEM"."AUTH_USER_USER_PERMISSIONS" ADD CONSTRAINT "AUTH_USER_PERMISSIO_1FBB5F2C_F" FOREIGN KEY ("PERMISSION_ID")
	  REFERENCES "SYSTEM"."AUTH_PERMISSION" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DJANGO_ADMIN_LOG
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" ADD CONSTRAINT "DJANGO_AD_CONTENT_T_C4BCE8EB_F" FOREIGN KEY ("CONTENT_TYPE_ID")
	  REFERENCES "SYSTEM"."DJANGO_CONTENT_TYPE" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" ADD CONSTRAINT "DJANGO_AD_USER_ID_C564EBA6_F" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."AUTH_USER" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PAQUETE_DESTINO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETE_DESTINO" ADD FOREIGN KEY ("ID_PAQUETE")
	  REFERENCES "SYSTEM"."PAQUETETURISTICO" ("ID_PAQUETE") ENABLE;
  ALTER TABLE "SYSTEM"."PAQUETE_DESTINO" ADD FOREIGN KEY ("ID_DESTINO")
	  REFERENCES "SYSTEM"."DESTINO" ("ID_DESTINO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PAQUETE_DESTINOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETE_DESTINOS" ADD FOREIGN KEY ("ID_PAQUETE")
	  REFERENCES "SYSTEM"."PAQUETETURISTICO" ("ID_PAQUETE") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."PAQUETE_DESTINOS" ADD FOREIGN KEY ("ID_DESTINO")
	  REFERENCES "SYSTEM"."DESTINO" ("ID_DESTINO") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PAQUETES_DESTINOS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAQUETES_DESTINOS" ADD FOREIGN KEY ("ID_PAQUETE")
	  REFERENCES "SYSTEM"."PAQUETES_TURISTICOS" ("ID_PAQUETE") ENABLE;
  ALTER TABLE "SYSTEM"."PAQUETES_DESTINOS" ADD FOREIGN KEY ("ID_DESTINO")
	  REFERENCES "SYSTEM"."DESTINOS" ("ID_DESTINO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table RESERVAS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."RESERVAS" ADD FOREIGN KEY ("ID_CLIENTE")
	  REFERENCES "SYSTEM"."CLIENTES" ("ID_CLIENTE") ENABLE;
  ALTER TABLE "SYSTEM"."RESERVAS" ADD FOREIGN KEY ("ID_PAQUETE")
	  REFERENCES "SYSTEM"."PAQUETES_TURISTICOS" ("ID_PAQUETE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SALAS_RESERVA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SALAS_RESERVA" ADD CONSTRAINT "SALAS_RES_SALA_ID_C9AA6ABE_F" FOREIGN KEY ("SALA_ID")
	  REFERENCES "SYSTEM"."SALAS_SALA" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
